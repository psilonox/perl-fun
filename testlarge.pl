#!/bin/perl
#joint venture between psilonox and scanlon
while (1) {
@array1 = ( "You are ","They are ","He is ","She is ","They were ","You were ","the past is ","the future is ");
@array2 = ( "going to ","designed to ","here to ","destined to ","willing to 
 ","Africanized
 ","Africanizes
 ","Africanizing
 ","Americanise
